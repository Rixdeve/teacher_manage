...
<head>
    <meta charset="UTF-8">
    <title>{{ $duty_leave_subject }}</title>
</head>
...
<body style="font-family: Arial, sans-serif; background-color: #f4f4f9; padding: 20px;">
    ...
    <div
        ...
        <div style="padding: 20px; text-align: left;">
            <h2 style="font-size: 16px; color: #333333;">Hi {{ $targetUserName }},</h2>
            <p style="font-size: 16px; color: #555555;">You have been assigned for a Duty Leave</p>
        </div>
        <!-- Body Section -->
