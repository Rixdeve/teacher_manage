...
<head>
    <meta charset="UTF-8">
    <title>{{ $principal_duty_leave_subject }}</title>
</head>
...
<body style="font-family: Arial, sans-serif; background-color: #f4f4f9; padding: 20px;">
    ...
    <div
        ...
        <div style="padding: 20px; text-align: left;">
            ...
            <p style="font-size: 16px; color: #555555;">{{$targetUserName}}. Has been Approved for Duty Leave.</p>
        </div>
        <!-- Body Section -->
        <div style="padding: 20px; font-size: 16px; color: #555555;">
            <p><strong>Teacher Name:</strong> {{ $targetUserName }}</p>
            ...
            <button
                ...
                <a href="https://tlmslanka.online/leave/record" style="text-decoration: none; color: white;">See
                    More</a>
            </button>
            <p>Thank you!</p>
            <p>Best regards,</p>
