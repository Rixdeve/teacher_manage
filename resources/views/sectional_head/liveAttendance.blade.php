...
<body class="bg-white flex items-center justify-center min-h-screen">
    <div class="w-full h-screen flex flex-col lg:flex-row">
        ...
        <div class="w-full lg:w-3/4 p-4 lg:p-8 relative">
            ...
            <button onclick="history.back()" class="absolute top-20 lg:top-6 left-4 lg:left-6 bg-gray-200 hover:bg-gray-300 text-gray-800 font-semibold py-1.5 px-3 lg:py-2 lg:px-4 rounded-lg shadow-md flex items-center" aria-label="Go back">
                <img src="https://cdn-icons-png.flaticon.com/512/271/271220.png" class="w-4 lg:w-5 h-4 lg:h-5 mr-2" alt="Back" />
                Back
            </button>

            <div class="max-w-6xl mx-auto bg-white shadow-md rounded-lg p-4 lg:p-6 mt-24 lg:mt-0">
                ...
                <div class="overflow-x-auto">
                    <table class="w-full table-auto border-collapse border border-gray-300">
                        <thead class="bg-gray-200">
                            <tr>
                                <th class="p-1 sm:p-2 border border-gray-300 text-sm sm:text-base">Photo</th>
                                <th class="p-1 sm:p-2 border border-gray-300 text-sm sm:text-base">First Name</th>
                                <th class="p-1 sm:p-2 border border-gray-300 text-sm sm:text-base">Last Name</th>
                                <th class="p-1 sm:p-2 border border-gray-300 text-sm sm:text-base">Subjects</th>
                            </tr>
                        </thead>
                        <tbody>
                            ...
                            <tr>
                                <td class="p-1 sm:p-2 border">
                                    <img src="{{ asset('storage/' . $record->user->profile_picture) }}" alt="Profile" class="w-10 sm:w-14 h-10 sm:h-14 self-center rounded-full border border-gray-400 mx-auto" />
                                </td>
                                <td class="p-1 sm:p-2 border text-sm sm:text-base">{{ $record->user->first_name }}</td>
                                <td class="p-1 sm:p-2 border text-sm sm:text-base">{{ $record->user->last_name }}</td>
                                <td class="p-1 sm:p-2 border text-sm sm:text-base">
                            ...
                            @empty
                            <tr>
                                <td colspan="4" class="p-4 text-center text-gray-500 text-sm sm:text-base">No attendance records found.</td>
                            </tr>
                            @endforelse
                        </tbody>
                    </table>
