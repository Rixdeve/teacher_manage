...
<body class="flex items-center justify-center min-h-screen">
    <div class="bg-white bg-opacity-90 shadow-lg rounded-lg w-full max-w-5xl p-8">
        ...
        <form method="post" action="/registerschool" class="grid grid-cols-2 gap-6">
            @csrf
            ...
            <div>
                ...
                <select id="school_status" name="school_status" class="w-full rounded-lg p-3 border" required>
