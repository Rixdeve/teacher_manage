        ...
        <div class="w-full lg:w-3/4 p-4 sm:p-6 lg:p-8 relative">
            ...
            <div class="max-w-full mx-auto p-4 sm:p-6 bg-white dark:bg-gray-800 rounded-2xl shadow-custom hover:shadow-custom-hover transition-shadow duration-300">
                <h2 class="text-xl sm:text-2xl lg:text-3xl font-bold text-gray-800 dark:text-white mb-4 sm:mb-6">
                    ...
                    <span class="ml-2 text-xs text-red-600 dark:text-red-200 bg-red-100 dark:bg-red-900 px-2 py-1 rounded-full animate-pulse">LIVE</span>
                </h2>
                <div class="max-h-[376px] sm:max-h-[336px] overflow-y-auto border border-gray-200 dark:border-gray-600 rounded-lg overflow-x-auto">
                    <table class="w-full table-auto border border-gray-200 dark:border-gray-600 text-sm sm:text-base">
                        <thead class="bg-red-100 dark:bg-red-900 text-red-700 dark:text-red-200 sticky top-0">
                            <tr>
                                ...
                                <th class="p-2 sm:p-3 border border-gray-200 dark:border-gray-600">Role</th>
                                <th class="p-2 sm:p-3 border border-gray-200 dark:border-gray-600">School Index</th>
                        ...
                        <tbody class="bg-white dark:bg-gray-800">
                            ...
                            <tr class="text-gray-800 dark:text-white">
                                <td class="p-2 sm:p-3 border border-gray-200 dark:border-gray-600 text-center">
                                    <img src="{{ asset('storage/' . $user->profile_picture) }}" alt="Profile" class="w-10 sm:w-14 h-10 sm:h-14 rounded-full border border-gray-400 dark:border-gray-600 mx-auto" />
                                </td>
                                <td class="p-2 sm:p-3 border border-gray-200 dark:border-gray-600 text-center">{{ $user->first_name }}</td>
                                <td class="p-2 sm:p-3 border border-gray-200 dark:border-gray-600 text-center">{{ $user->last_name }}</td>
                                <td class="p-2 sm:p-3 border border-gray-200 dark:border-gray-600 text-center">{{ ucfirst(strtolower($user->role)) }}</td>
                                <td class="p-2 sm:p-3 border border-gray-200 dark:border-gray-600 text-center">{{ $user->school_index }}</td>
                                <td class="p-2 sm:p-3 border border-gray-200 dark:border-gray-600 text-center">{{ $user->section }}</td>
                                <td class="p-2 sm:p-3 border border-gray-200 dark:border-gray-600 text-center">
                            ...
                            @empty
                            <tr>
                                <td colspan="7" class="p-4 sm:p-6 text-center text-gray-600 dark:text-gray-400">No Absentees To Display</td>
                            </tr>
                            @endforelse
                        </tbody>
                    </table>
