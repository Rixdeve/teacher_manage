...
<body class="bg-white text-black dark:bg-gray-900 dark:text-white font-sans flex items-center justify-center min-h-screen antialiased">
    ...
    <div class="bg-white shadow-lg rounded-lg w-full h-screen flex">
        ...
        <div id="sidebar"
            class="hidden lg:flex w-full lg:w-1/4 bg-white lg:bg-gradient-to-b from-blue-100 to-gray-500 p-4 lg:p-6 m-0 lg:m-4 rounded-none lg:rounded-xl shadow-none lg:shadow-md flex-col items-center fixed lg:static top-0 left-0 h-[90vh] lg:h-auto overflow-y-auto z-40 bg-opacity-95">
        ...
        <div class="flex-1 lg:w-3/4 p-4 lg:p-8 relative">
            <button onclick="history.back()"
                class="hidden lg:block absolute top-6 left-6 bg-gray-200 hover:bg-gray-300 text-gray-800 font-semibold py-2 px-4 rounded-lg shadow-md flex items-center">
            ...
            <div class="absolute top-16 lg:top-6 right-4 lg:right-6 flex items-center space-x-3">
                <img src="{{ asset('storage/' . Auth::user()->profile_picture) }}"
                    class="h-8 lg:h-10 w-8 lg:w-10 rounded-full border border-gray-400" />
                <div>
                    <a href="{{ url('/show') }}">
            ...
            <div class="mt-32 lg:mt-12">
                <div class="max-w-6xl mx-auto p-6 bg-white rounded shadow">
                    ...
                    <form method="POST" action="{{ route('attendance.store') }}">
                        ...
                        <!-- Date Picker -->
                        <div class="mb-4">
                            <label for="attendance_date" class="block text-gray-700 font-medium mb-2">Select
                                Date:</label>
