    ...
    <div class="w-full min-h-screen flex flex-col lg:flex-row">
        ...
        <div id="sidebar" class="hidden lg:flex w-full lg:w-1/4 bg-gradient-to-b from-blue-100 to-gray-500 dark:from-gray-800 dark:to-gray-600 p-6 m-0 lg:m-4 rounded-none lg:rounded-2xl shadow-none lg:shadow-custom flex-col items-center fixed lg:static top-0 left-0 h-[100vh] lg:h-auto max-h-[95vh] z-40 transition-transform duration-300 ease-in-out transform lg:transform-none bg-opacity-95 overflow-y-auto">
            ...
            <ul class="space-y-3 w-full">
                <li class="w-full py-3 flex items-center text-gray-800 dark:text-white font-semibold cursor-pointer hover:bg-gray-200 dark:hover:bg-gray-700 rounded-lg p-3 mx-auto transition-colors duration-   <a href="{{ url('/clerkDashboard') }}" class="flex items-center w-full">
                        ...
                        <tbody class="bg-white dark:bg-gray-800">
                            ...
                            <tr class="text-gray-800 dark:text-white">
                                <td class="p-2 sm:p-3 border border-gray-200 dark:border-gray-600 text-center">
                                    <img src="{{ asset('storage/' . $record->user->profile_picture) }}" alt="Profile" class="w-10 sm:w-14 h-10 sm:h-14 rounded-full border border-gray-400 dark:border-gray-600 mx-auto" />
                                </td>
                                <td class="p-2 sm:p-3 border border-gray-200 dark:border-gray-600 text-center">{{ $record->user->first_name }}</td>
                                <td class="p-2 sm:p-3 border border-gray-200 dark:border-gray-600 text-center">{{ $record->user->last_name }}</td>
                                <td class="p-2 sm:p-3 border border-gray-200 dark:border-gray-600 text-center">{{ $record->user->section }}</td>
                                <td class="p-2 sm:p-3 border border-gray-200 dark:border-gray-600 text-center">
                            ...
                            @empty
                            <tr>
                                <td colspan="5" class="p-4 sm:p-6 text-center text-gray-600 dark:text-gray-400">No Attendance Records Found</td>
                            </tr>
                            @endforelse
                        </tbody>
                    </table>
