    ...
    <div class="w-full min-h-screen flex flex-col lg:flex-row">
        ...
        <div id="sidebar"
            ...
            <ul class="space-y-3 w-full">
                <li
                    class="w-full py-3 flex items-center text-gray-800 dark:text-white font-semibold cursor-pointer bg-gray-200 dark:bg-gray-700 rounded-lg p-3 mx-auto transition-colors duration-200">
                ...
                <li
                    class="w-full py-3 flex items-center text-gray-800 dark:text-white font-semibold cursor-pointer hover:bg-gray-200 dark:hover:bg-gray-600 rounded-lg p-3 mx-auto transition-colors duration-200">
        ...
        <div class="w-full lg:w-3/4 p-4 sm:p-6 lg:p-8 relative">
            ...
            <!-- Welcome Section -->
            <div
                class="bg-gradient-to-b from-blue-100 to-gray-500 dark:from-gray-800 dark:to-gray-600 p-4 sm:p-6 rounded-2xl mb-6 sm:mb-8 shadow-custom hover:shadow-custom-hover transition-shadow duration-300">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
                <div
                    class="bg-blue-100 dark:bg-gray-800 p-4 sm:p-6 rounded-2xl text-center shadow-custom hover:shadow-custom-hover transition-all duration-300 transform hover:-translate-y-1">
                    <p class="text-gray-700 dark:text-gray-300 font-semibold text-sm sm:text-base mb-2">Manual
                        Attendance Marking</p>
                    <img src="{{ asset('storage/photos/fingerprint-scan.png') }}"
                        class="w-10 sm:w-12 h-10 sm:h-12 mx-auto mb-4" alt="Manual Attendance" />
                    <a href="{{ url('/manualAttendance') }}"
                        class="inline-block bg-gray-200 hover:bg-gray-300 dark:bg-gray-700 dark:hover:bg-gray-600 text-gray-800 dark:text-white py-1.5 sm:py-2 px-3 sm:px-4 rounded-full transition-colors duration-300 text-xs sm:text-sm">Mark
                        Now</a>
                </div>
                <div
                    class="bg-blue-100 dark:bg-gray-800 p-4 sm:p-6 rounded-2xl text-center shadow-custom hover:shadow-custom-hover transition-all duration-300 transform hover:-translate-y-1">
                    <p class="text-gray-700 dark:text-gray-300 font-semibold text-sm sm:text-base mb-2">Live Attendance
                    </p>
                    <img src="{{ asset('storage/photos/live.png') }}" class="w-10 sm:w-12 h-10 sm:h-12 mx-auto mb-4"
                        alt="Live Attendance" />
                    <a href="{{ url('/liveAttendanceclerk') }}"
                        class="inline-block bg-gray-200 hover:bg-gray-300 dark:bg-gray-700 dark:hover:bg-gray-600 text-gray-800 dark:text-white py-1.5 sm:py-2 px-3 sm:px-4 rounded-full transition-colors duration-300 text-xs sm:text-sm">View
                        Now</a>
                </div>
                <div
                    class="bg-blue-100 dark:bg-gray-800 p-4 sm:p-6 rounded-2xl text-center shadow-custom hover:shadow-custom-hover transition-all duration-300 transform hover:-translate-y-1">
                    <p class="text-gray-700 dark:text-gray-300 font-semibold text-sm sm:text-base mb-2">Live Absentees
                    </p>
                    <img src="{{ asset('storage/photos/absence.png') }}" class="w-10 sm:w-12 h-10 sm:h-12 mx-auto mb-4"
                        alt="Live Absentees" />
