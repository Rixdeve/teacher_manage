    ...
    <div class="w-full min-h-screen flex flex-col lg:flex-row">
        ...
        <div class="w-full lg:w-3/4 p-4 sm:p-6 lg:p-8 relative">
            ...
            <div class="max-w-full mx-auto p-4 sm:p-6 bg-white dark:bg-gray-800 rounded-2xl shadow-custom hover:shadow-custom-hover transition-shadow duration-300">
                <h2 class="text-xl sm:text-2xl lg:text-3xl font-bold text-gray-800 dark:text-white mb-4 sm:mb-6">Apply Leave for Teacher</h2>
                <form action="{{ route('leave.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf

                    <div class="max-h-[400px] sm:max-h-[360px] overflow-y-auto border border-gray-200 dark:border-gray-600 rounded-lg p-4 sm:p-6">
                        <div class="mb-4">
                            <label for="user_id" class="block text-gray-700 dark:text-gray-300 font-semibold text-sm sm:text-base mb-1 sm:mb-2">Select User</label>
                            <select
                                name="user_id"
                                id="user_id"
                            ...
                            >
                                ...
                                <option value="{{ $user->id }}">{{ $user->first_name }} {{ $user->last_name }} ({{ ucfirst(strtolower($user->role)) }})</option>
                                @endforeach
                            </select>
                        </div>

                        <div class="mb-4">
                            <label for="commence_date" class="block text-gray-700 dark:text-gray-300 font-semibold text-sm sm:text-base mb-1 sm:mb-2">From Date</label>
                            <input
                                type="date"
                                name="commence_date"
                                id="commence_date"
                        ...
                        <div class="mb-4">
                            <label for="end_date" class="block text-gray-700 dark:text-gray-300 font-semibold text-sm sm:text-base mb-1 sm:mb-2">To Date</label>
                            <input
                                type="date"
                                name="end_date"
                                id="end_date"
                        ...
                        <div class="mb-4">
                            <label for="leave_type" class="block text-gray-700 dark:text-gray-300 font-semibold text-sm sm:text-base mb-1 sm:mb-2">Leave Type</label>
                            <select
                                name="leave_type"
                                id="leave_type"
                                class="w-full p-3 sm:p-4 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-800 text-gray-800 dark:text-white focus:outline-none focus:ring-2 focus:ring-blue-500 dark:focus:ring-blue-600 transition-colors duration-200 text-sm sm:text-base"
                        ...
                        <div class="mb-4">
                            <label for="reason" class="block text-gray-700 dark:text-gray-300 font-semibold text-sm sm:text-base mb-1 sm:mb-2">Reason</label>
                            <textarea
                                name="reason"
                                id="reason"
                                rows="4"
                        ...
                        <div class="mb-4 sm:mb-6">
                            <label for="attachments" class="block text-gray-700 dark:text-gray-300 font-semibold text-sm sm:text-base mb-1 sm:mb-2">Attachments (up to 3, optional)</label>
                            <input
                                type="file"
                                name="attachments[]"
                                id="attachments"
                    ...
                    <div class="mt-4 sm:mt-6">
                        <button
                            type="submit"
                            class="bg-gray-500 hover:bg-gray-600 dark:bg-gray-600 dark:hover:bg-gray-700 text-white px-4 sm:px-6 py-2 sm:py-3 rounded-full shadow-md hover:shadow-custom-hover transition-colors duration-300 w-full sm:w-auto text-sm sm:text-base"
                        >
                            Submit Application
                        </button>
                    </div>
