...
<body >
    <div class="bg-white shadow-lg rounded-lg w-full h-screen flex">
        ...
        <div class="w-full lg:w-3/4 p-4 lg:p-8 relative">
            ...
            <div class="max-w-full lg:max-w-6xl mx-auto bg-white shadow-md rounded-lg p-4 lg:p-6 mt-16 lg:mt-0">
                ...
                <div class="overflow-x-auto">
                    <table class="w-full table-auto border-collapse border border-gray-300">
                        <thead class="bg-gray-200">
                            <tr>
                                <th class="p-1 lg:p-2 border border-gray-300 text-sm lg:text-base">Photo</th>
                                <th class="p-1 lg:p-2 border border-gray-300 text-sm lg:text-base">First Name</th>
                                <th class="p-1 lg:p-2 border border-gray-300 text-sm lg:text-base">Last Name</th>
                                <th class="p-1 lg:p-2 border border-gray-300 text-sm lg:text-base">School Index</th>
                                <th class="p-1 lg:p-2 border border-gray-300 text-sm lg:text-base">Section</th>
                                <th class="p-1 lg:p-2 border border-gray-300 text-sm lg:text-base">Subjects</th>
                            </tr>
                        </thead>
                        <tbody>
                            @forelse($attendances as $record)
                            <tr>
                                <td class="p-1 lg:p-2 border">
                                    <img src="{{ asset('storage/' . $record->user->profile_picture) }}" alt="Profile" class="w-10 lg:w-14 h-10 lg:h-14 self-center rounded-full border border-gray-400 mx-auto" />
                                </td>
                                <td class="p-1 lg:p-2 border text-sm lg:text-base">{{ $record->user->first_name }}</td>
                                <td class="p-1 lg:p-2 border text-sm lg:text-base">{{ $record->user->last_name }}</td>
                                <td class="p-1 lg:p-2 border text-sm lg:text-base">{{ $record->user->school_index }}</td>
                                <td class="p-1 lg:p-2 border text-sm lg:text-base">{{ $record->user->section }}</td>
                                <td class="p-1 lg:p-2 border text-sm lg:text-base">
                            ...
                            @empty
                            <tr>
                                <td colspan="6" class="p-2 lg:p-4 text-center text-gray-500 text-sm lg:text-base">No attendance records found.</td>
                            </tr>
                            @endforelse
                        </tbody>
                    </table>
