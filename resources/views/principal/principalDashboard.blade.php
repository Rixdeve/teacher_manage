...
<body class="bg-white flex items-center justify-center min-h-screen">
    ...
    <div class="bg-white shadow-lg rounded-lg w-full h-screen flex">
        ...
        <div class="w-full lg:w-3/4 p-4 lg:p-8 relative">
            <button onclick="history.back()" class="absolute top-16 lg:top-6 left-4 lg:left-6 bg-gray-200 hover:bg-gray-300 text-gray-800 font-semibold py-1.5 lg:py-2 px-3 lg:px-4 rounded-lg shadow-md flex items-center">
                <img src="https://cdn-icons-png.flaticon.com/512/271/271220.png" class="w-4 lg:w-5 h-4 lg:h-5 mr-2" alt="Back" />
                Back
            </button>

            <div class="absolute top-24 lg:top-6 right-4 lg:right-6 flex items-center space-x-3">
                ...
                <div class="grid grid-cols-1 lg:grid-cols-3 gap-4 lg:gap-6">
                    <div class="bg-blue-100 p-4 lg:p-6 rounded-lg text-center shadow-md hover:shadow-lg">
                        <div class="flex flex-col items-center justify-center">
                            <p class="text-gray-700 font-semibold text-sm lg:text-base">Attendance</p>
                            <h3 class="text-2xl lg:text-3xl font-bold text-gray-700"></h3>
                        </div>
                    </div>
                    <div class="bg-blue-100 p-4 lg:p-6 rounded-lg text-center shadow-md hover:shadow-lg">
                        <div class="flex flex-col items-center justify-center">
                    ...
                    <div class="bg-blue-100 p-4 lg:p-6 rounded-lg text-center shadow-md hover:shadow-lg">
                        <div class="flex flex-col items-center justify-center">
                            <p class="text-gray-700 font-semibold text-sm lg:text-base">Absentees</p>
                            <h3 class="text-2xl lg:text-3xl font-bold text-gray-700"></h3>
                        </div>
                    </div>
                    <div class="bg-blue-100 p-4 lg:p-6 rounded-lg text-center shadow-md hover:shadow-lg">
                        <div class="flex flex-col items-center justify-center">
                            <p class="text-gray-700 font-semibold text-sm lg:text-base">On Leave</p>
                            <h3 class="text-2xl lg:text-3xl font-bold text-gray-700">0</h3>
                        </div>
                    </div>
                    <div class="bg-blue-100 p-4 lg:p-6 rounded-lg text-center shadow-md hover:shadow-lg">
                        <div class="flex flex-col items-center justify-center">
                            <a href="{{ url('/attendanceReport') }}">
                                <p class="text-gray-700 font-semibold text-sm lg:text-base">View All</p>
                                <img src="{{asset('storage/photos/fingerprint-scan.png')}}" class="w-8 lg:w-12 h-8 lg:h-12 mb-2 lg:mb-4" alt="Short Leave" />
                            </a>
                        </div>
                    </div>
                </div>
