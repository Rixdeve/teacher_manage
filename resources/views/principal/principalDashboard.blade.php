    ...
    <div class="w-full h-screen flex flex-col lg:flex-row">
        ...
        <div id="sidebar"
            ...
            <ul class="space-y-3 w-full">
                <li
                    class="w-full py-3 flex items-center text-black font-semibold cursor-pointer bg-gray-200 rounded-lg p-3 mx-auto transition-colors duration-200">
        ...
        <div class="w-full lg:w-3/4 p-4 lg:p-6 relative bg-white rounded-2xl m-0 lg:m-4 shadow-custom">
            <button onclick="history.back()"
                class="absolute top-4 lg:top-4 left-4 lg:left-4 bg-gray-200 hover:bg-gray-300 text-gray-800 font-semibold py-1.5 px-3 rounded-full shadow-md hover:shadow-custom-hover flex items-center transition-shadow duration-300"
                aria-label="Go back">
            ...
            <div class="absolute top-4 lg:top-4 right-4 lg:right-4 flex items-center space-x-4 group z-10">
                <img src="{{ asset('storage/' . Auth::user()->profile_picture) }}"
                    class="h-8 w-8 rounded-full border-2 border-gray-400 shadow-md transition-transform duration-300 group-hover:scale-105"
                    alt="Profile" />
                <a href="{{ url('/show') }}" class="text-right">
                    <h3 class="font-semibold text-sm text-gray-800">{{ Auth::user()->first_name }}
                        {{ Auth::user()->last_name }}
                    </h3>
            ...
            <div class="mt-16 lg:mt-12">
                <div
                    class="bg-gradient-to-b from-blue-100 to-gray-500 p-4 lg:p-5 rounded-2xl mb-4 shadow-custom hover:shadow-custom-hover transition-shadow duration-300">
