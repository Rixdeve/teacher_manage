    ...
    <div class="bg-white shadow-lg rounded-lg w-full h-screen flex">
        ...
        <div class="w-full lg:w-3/4 p-4 lg:p-8 relative">
            ...
            <div class="mt-32 lg:mt-12">
                ...
                @if (session('error'))
                    <div class="bg-red-100 border-l-4 border-red-500 text-red-700 p-3 lg:p-4 mb-4 lg:mb-6 rounded" role="alert">
                        {{ session('error') }}
                    </div>
                @endif
                @if (session('success'))
                    <div class="bg-green-100 border-l-4 border-green-500 text-green-700 p-3 lg:p-4 mb-4 lg:mb-6 rounded" role="alert">
                        {{ session('success') }}
                    </div>
                @endif
                            ...
                            <tbody>
                                @foreach ($approvedLeaves as $leave)
                                    <tr class="border-b hover:bg-gray-50">
                                        ...
                                        <td class="p-2 lg:p-3 text-sm lg:text-base">{{ $leave->user ? ucfirst(strtolower($leave->user->role)) : 'N/A' }}</td>
                                        ...
                                        <td class="p-2 lg:p-3 text-sm lg:text-base">{{ $leave->latestStatus->updated_at->format('Y-m-d H:i:s') }}</td>
                                    </tr>
                                @endforeach
                            </tbody>
                        </table>
