...
<body class="h-screen flex items-center justify-center bg-gray-100">
    <div class="w-full h-screen flex shadow-lg">
        <div class="w-1/2 h-full bg-cover bg-center"
            style="background-image:
            url('https://www.bci.lk/wp-content/uploads/2022/04/Bachelor-of-Education-Honours-in-Primary-Education.jpg')"> </div>

        <div class="w-1/2 h-full bg-white flex flex-col justify-center items-center p-16 shadow-md rounded-lg">
