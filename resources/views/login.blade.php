...
<body class="bg-gray-100 font-sans min-h-screen antialiased flex items-center justify-center">
    <div class="w-full h-screen flex flex-col lg:flex-row shadow-custom rounded-none overflow-hidden">
        ...
        <div class="w-full lg:w-1/2 bg-gradient-to-b from-blue-50 to-gray-100 flex flex-col justify-center items-center p-4 lg:p-8 rounded-none">
            ...
            <form action="{{ route('login.submit') }}" method="POST" class="w-full max-w-md">
                @csrf
                <div class="max-h-[300px] overflow-y-auto p-6 border border-gray-200 rounded-2xl mb-6 bg-white shadow-custom">
                    <div class="mb-4">
                        <label for="user_email" class="block text-gray-700 text-sm lg:text-base font-semibold">Email</label>
                        <div class="relative">
                    ...
                    <div class="mb-4">
                        <label for="user_password" class="block text-gray-700 text-sm lg:text-base font-semibold">Password</label>
                        <div class="relative">
                            <input type="password" id="user_password" name="user_password"
                                class="w-full p-3 pl-10 mt-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-600 focus:border-blue-600 shadow-sm bg-white transition-transform duration-300 focus:scale-105"
                                placeholder="Enter your password" required />
                            <svg class="absolute left-3 top-1/2 transform -translate-y-1/2 w-5 h-5 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 11c0-1.1-.9-2-2-2s-2 .9-2 2 2 4 2 4m2-4c0-1.1.9-2 2-2s2 .9 2 2-2 4-2 4m-6 5c0 1.1.9 2 2 2s2-.9 2-2m-8-7h16m-2-7H6a2 2 0 00-2 2v12a2 2 0 002 2h12a2 2 0 002-2V5a2 2 0 00-2-2z"></path>
                            </svg>
                        </div>
                        @error('user_password')
                        <span class="text-red-500 text-sm mt-1">{{ $message }}</span>
                ...
                <div class="bg-red-100 text-red-500 p-4 rounded-2xl mb-6 border border-red-200 shadow-custom animate-pulse">
