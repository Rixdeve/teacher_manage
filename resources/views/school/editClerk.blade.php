    ...
    <div class="w-full h-screen flex flex-col lg:flex-row">
        ...
        <div class="w-full lg:w-3/4 p-6 lg:p-8 relative">
            ...
            <div class="bg-gradient-to-b from-blue-100 to-gray-500 p-6 rounded-2xl mb-8 shadow-custom hover:shadow-custom-hover transition-shadow duration-300 mt-20 lg:mt-16">
                <h2 class="text-2xl lg:text-3xl font-bold text-gray-800 text-center">Edit Clerk</h2>
            </div>

            <a href="{{ route('clerks.manage') }}" class="inline-block bg-gray-200 hover:bg-gray-300 text-gray-800 font-semibold py-2 px-4 rounded-full shadow-md hover:shadow-custom-hover transition-all duration-300 mb-6">
                ← Back to Manage Clerks
            </a>
                    ...
                    <div class="space-y-6">
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            <div>
                                ...
                                <input type="text" id="first_name" name="first_name" value="{{ $clerk->first_name }}" class="mt-1 p-3 border border-gray-300 rounded-lg w-full focus:ring-2 focus:ring-blue-500" required />
                            </div>
                            <div>
                                <label for="last_name" class="block text-sm font-medium text-gray-800">Last Name</label>
                                <input type="text" id="last_name" name="last_name" value="{{ $clerk->last_name }}" class="mt-1 p-3 border border-gray-300 rounded-lg w-full focus:ring-2 focus:ring-blue-500" required />
                            </div>
                        </div>
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            <div>
                                ...
                                <input type="text" id="school_index" name="school_index" value="{{ $clerk->school_index }}" class="mt-1 p-3 border border-gray-300 rounded-lg w-full focus:ring-2 focus:ring-blue-500" required />
                            </div>
                            <div>
                                <label for="user_email" class="block text-sm font-medium text-gray-800">Email</label>
                                <input type="email" id="user_email" name="user_email" value="{{ $clerk->user_email }}" class="mt-1 p-3 border border-gray-300 rounded-lg w-full focus:ring-2 focus:ring-blue-500" required />
                            </div>
                        </div>
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            <div>
                                ...
                                <input type="text" id="user_phone" name="user_phone" value="{{ $clerk->user_phone }}" class="mt-1 p-3 border border-gray-300 rounded-lg w-full focus:ring-2 focus:ring-blue-500" required />
                            </div>
                            <div>
                                <label for="user_nic" class="block text-sm font-medium text-gray-800">NIC</label>
                                <input type="text" id="user_nic" name="user_nic" value="{{ $clerk->user_nic }}" class="mt-1 p-3 border border-gray-300 rounded-lg w-full focus:ring-2 focus:ring-blue-500" required />
                            </div>
                        </div>
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            <div>
                                ...
                                <input type="text" id="user_address_no" name="user_address_no" value="{{ $clerk->user_address_no }}" class="mt-1 p-3 border border-gray-300 rounded-lg w-full focus:ring-2 focus:ring-blue-500" required />
                            </div>
                            <div>
                                <label for="user_address_street" class="block text-sm font-medium text-gray-800">Address Street</label>
                                <input type="text" id="user_address_street" name="user_address_street" value="{{ $clerk->user_address_street }}" class="mt-1 p-3 border border-gray-300 rounded-lg w-full focus:ring-2 focus:ring-blue-500" required />
                            </div>
                        </div>
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            <div>
                                ...
                                <input type="text" id="user_address_city" name="user_address_city" value="{{ $clerk->user_address_city }}" class="mt-1 p-3 border border-gray-300 rounded-lg w-full focus:ring-2 focus:ring-blue-500" required />
                            </div>
                            <div>
                                <label for="user_dob" class="block text-sm font-medium text-gray-800">Date of Birth</label>
                                <input type="date" id="user_dob" name="user_dob" value="{{ \Carbon\Carbon::parse($clerk->user_dob)->format('Y-m-d') }}" class="mt-1 p-3 border border-gray-300 rounded-lg w-full focus:ring-2 focus:ring-blue-500" required />
                            </div>
                        </div>
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            <div>
                                ...
                                <img src="{{ asset('storage/' . $clerk->profile_picture) }}" class="w-24 h-24 rounded-lg shadow border mt-1 mb-3" alt="Profile Picture" />
                                @else
