    ...
    <div class="bg-white shadow-lg rounded-lg w-full h-screen flex">
        ...
        <div
            ...
            <ul class="space-y-4 w-full">
                <li
                    class="w-48 py-2 flex items-center text-black font-semibold hover:bg-gray-200 rounded-lg p-2 mx-auto">
                ...
                <li
                    ...
                    <a href="{{ url('/registerClerk') }}" class="flex items-center w-full">
                        <img src="{{ asset('storage/photos/immigration.png') }}" class="w-8 h-8 mr-2"
                            alt="Assign Clerk" /> Assign Clerk
                    </a>
                </li>
                <li
                    class="w-48 py-2 flex items-center text-black font-semibold hover:bg-gray-200 rounded-lg p-2 mx-auto">
                    <a href="{{ url('/registerTeacher') }}" class="flex items-center w-full">
                        <img src="{{ asset('storage/photos/classroom.png') }}" class="w-8 h-8 mr-2"
                            alt="Assign Teacher" /> Assign Teacher
                    </a>
                </li>
                <li
                    class="w-48 py-2 flex items-center text-black font-semibold hover:bg-gray-200 rounded-lg p-2 mx-auto">
                    <a href="{{ url('/registerSectionhead') }}" class="flex items-center w-full">
                        <img src="{{ asset('storage/photos/teachernew.png') }}" class="w-8 h-8 mr-2"
                            alt="Assign Section" /> Assign Sectional Head
                    </a>
                </li>
                <li
                    class="mt-12 w-48 py-2 flex items-center text-red-500 font-bold hover:text-red-700 hover:bg-gray-300 rounded-lg p-2 mx-auto">
        ...
        <div class="w-3/4 p-8 overflow-y-auto">
            <a href="{{ route('clerks.manage') }}"
                class="inline-block bg-gray-200 hover:bg-gray-300 text-gray-800 font-semibold py-2 px-4 rounded shadow mb-4">
                < Back </a>
                    ...
                    <form action="{{ route('clerks.update', $clerk->id) }}" method="POST" enctype="multipart/form-data"
                        class="space-y-6">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="space-y-4">
                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                ...
                                <div>
                                    <label for="last_name" class="block text-lg font-medium text-gray-800">Last
                                        Name</label>
                                    <input type="text" id="last_name" name="last_name" value="{{ $clerk->last_name }}"
                                        class="mt-2 p-3 border border-gray-300 rounded-lg w-full" required />
                                </div>
                            </div>
                            ...
                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <input type="text" id="school_index" name="school_index"
                                        value="{{ $clerk->school_index }}"
                                        class="mt-2 p-3 border border-gray-300 rounded-lg w-full" required />
                                </div>
                                <div>
                                    <label for="user_email"
                                        class="block text-lg font-medium text-gray-800">Email</label>
                                    <input type="email" id="user_email" name="user_email"
                                        value="{{ $clerk->user_email }}"
                                        class="mt-2 p-3 border border-gray-300 rounded-lg w-full" required />
                                </div>
                            </div>
                            ...
                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                <div>
                                    <label for="user_phone" class="block text-lg font-medium text-gray-800">Phone
                                        Number</label>
                                    <input type="text" id="user_phone" name="user_phone"
                                        value="{{ $clerk->user_phone }}"
                                        class="mt-2 p-3 border border-gray-300 rounded-lg w-full" required />
                                </div>
                                <div>
                                    <label for="user_nic" class="block text-lg font-medium text-gray-800">NIC</label>
                                    <input type="text" id="user_nic" name="user_nic" value="{{ $clerk->user_nic }}"
                                        class="mt-2 p-3 border border-gray-300 rounded-lg w-full" required />
                                </div>
                            </div>
                            ...
                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                <div>
                                    <label for="user_address_no" class="block text-lg font-medium text-gray-800">Address
                                        No</label>
                                    <input type="text" id="user_address_no" name="user_address_no"
                                        value="{{ $clerk->user_address_no }}"
                                        class="mt-2 p-3 border border-gray-300 rounded-lg w-full" required />
                                </div>
                                <div>
                                    <label for="user_address_street"
                                        class="block text-lg font-medium text-gray-800">Address Street</label>
                                    <input type="text" id="user_address_street" name="user_address_street"
                                        value="{{ $clerk->user_address_street }}"
                                        class="mt-2 p-3 border border-gray-300 rounded-lg w-full" required />
                                </div>
                            </div>
                            ...
                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                <div>
                                    <label for="user_address_city"
                                        class="block text-lg font-medium text-gray-800">Address City</label>
                                    <input type="text" id="user_address_city" name="user_address_city"
                                        value="{{ $clerk->user_address_city }}"
                                        class="mt-2 p-3 border border-gray-300 rounded-lg w-full" required />
                                </div>
                                <div>
                                    <label for="user_dob" class="block text-lg font-medium text-gray-800">Date of
                                        Birth</label>
                                    <input type="date" id="user_dob" name="user_dob"
                                        value="{{ \Carbon\Carbon::parse($clerk->user_dob)->format('Y-m-d') }}"
                                        class="mt-2 p-3 border border-gray-300 rounded-lg w-full" required />
                                </div>
                            </div>
                            ...
                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                <div>
                                    <label for="profile_picture" class="block text-lg font-medium text-gray-800">Profile
                                        Photo</label>
                                    ...
                                    <p class="mt-2 text-sm text-gray-600">Current:
                                        <img src="{{ asset('storage/' . $clerk->profile_picture) }}"
                                            class="w-20 h-20 rounded mt-2" alt="Profile Picture" />
                                    </p>
                                    @endif
                                </div>
                            </div>
