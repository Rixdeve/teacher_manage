        ...
        <div class="w-3/4 p-8 overflow-y-auto">
            <a href="{{ url('/manageUsers') }}" class="inline-block bg-gray-200 hover:bg-gray-300 text-gray-800 font-semibold py-2 px-4 rounded shadow mb-4">
                < Back
                    ...
                    <h2 class="text-2xl font-bold mb-6 text-center">Manage Teachers</h2>
                    ...
                    <table class="min-w-full bg-white border rounded shadow">
                        ...
                        <tbody>
                            ...
                            <tr class="hover:bg-gray-100">
                                <td class="py-2 px-4 border">{{ $teacher->first_name }} {{ $teacher->last_name }}</td>
                                <td class="py-2 px-4 border">{{ $teacher->user_email }}</td>
                                <td class="py-2 px-4 border">{{ $teacher->section ?? 'N/A' }}</td>
                                <td class="py-2 px-4 border">{{ ucfirst($teacher->status) }}</td>
                                <td class="py-2 px-4 border space-x-1">
                                    <a href="{{ route('teachers.edit', $teacher->id) }}" class="bg-blue-500 hover:bg-blue-600 text-white font-semibold py-1 px-3 rounded mr-1">Edit</a>
