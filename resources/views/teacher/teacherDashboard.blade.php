...
<body class="bg-white text-black dark:bg-gray-900 dark:text-white font-sans flex items-center justify-center min-h-screen antialiased">
    <div class="w-full h-screen flex flex-col lg:flex-row">
        ...
        <div class="w-full lg:w-3/4 p-6 lg:p-8 relative">
            ...
            <div>
                <h2 class="text-2xl lg:text-3xl font-semibold text-gray-800 dark:text-white mb-6">Apply Leaves</h2>
            </div>

            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                <div
                    class="bg-blue-100 dark:bg-gray-800 p-6 rounded-2xl text-center shadow-custom hover:shadow-custom-hover transition-all duration-300 transform hover:-translate-y-1">
                    <p class="text-gray-700 dark:text-gray-300 font-semibold text-base mb-2">Casual Leaves</p>
                    <img src="{{ asset('storage/photos/exit.png') }}" class="w-12 h-12 mx-auto mb-4"
                        alt="Casual Leave" />
                    <a href="{{ route('leave.create') }}"
                        class="inline-block bg-gray-200 dark:bg-gray-700 text-gray-800 dark:text-white py-2 px-4 rounded-full hover:bg-gray-300 dark:hover:bg-gray-600 transition-colors duration-300">Apply
                        Now</a>
                </div>
                <div
                    class="bg-blue-100 dark:bg-gray-800 p-6 rounded-2xl text-center shadow-custom hover:shadow-custom-hover transition-all duration-300 transform hover:-translate-y-1">
                    <p class="text-gray-700 dark:text-gray-300 font-semibold text-base mb-2">Medical Leave</p>
                ...
                <div
                    class="bg-blue-100 dark:bg-gray-800 p-6 rounded-2xl text-center shadow-custom hover:shadow-custom-hover transition-all duration-300 transform hover:-translate-y-1">
                    <p class="text-gray-700 dark:text-gray-300 font-semibold text-base mb-2">Short Leaves</p>
                ...
                <div
                    class="bg-blue-100 dark:bg-gray-800 p-6 rounded-2xl text-center shadow-custom hover:shadow-custom-hover transition-all duration-300 transform hover:-translate-y-1">
                    <p class="text-gray-700 dark:text-gray-300 font-semibold text-base mb-2">View Notifications</p>
                    ...
                    <a href="{{ route('teacher.notifications') }}"
                        class="inline-block bg-gray-200 dark:bg-gray-700 text-gray-800 dark:text-white py-2 px-4 rounded-full hover:bg-gray-300 dark:hover:bg-gray-600 transition-colors duration-300">View
                        Now</a>
                </div>
                <div
                    class="bg-blue-100 dark:bg-gray-800 p-6 rounded-2xl text-center shadow-custom hover:shadow-custom-hover transition-all duration-300 transform hover:-translate-y-1">
                    <p class="text-gray-700 dark:text-gray-300 font-semibold text-base mb-2">Leave application Status</p>
                ...
                <div
                    class="bg-blue-100 dark:bg-gray-800 p-6 rounded-2xl text-center shadow-custom hover:shadow-custom-hover transition-all duration-300 transform hover:-translate-y-1">
                    <p class="text-gray-700 dark:text-gray-300 font-semibold text-base mb-2">My profile</p>
