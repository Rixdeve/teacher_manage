            ...
            <ul class="space-y-3 w-full">
                ...
                <li class="w-full py-3 flex items-center text-black font-semibold cursor-pointer hover:bg-gray-200 rounded-lg p-3 mx-auto transition-colors duration-200">
                    <a href="{{ route('teacher.notifications') }}" class="flex items-center w-full">
                        <img src="https://cdn-icons-png.freepik.com/256/3602/3602175.png?semt=ais_hybrid" class="w-8 h-8 mr-3" alt="Notifications" />
                        Notifications
                    </a>
                </li>
                <li class="w-full py-3 flex items-center text-black font-semibold cursor-pointer hover:bg-gray-200 rounded-lg p-3 mx-auto transition-colors duration-200">
        ...
        <div class="w-full lg:w-3/4 p-6 lg:p-8 relative">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                <div class="bg-blue-100 p-6 rounded-2xl text-center shadow-custom hover:shadow-custom-hover transition-all duration-300 transform hover:-translate-y-1">
                    ...
                    <a href="{{ route('leave.create') }}" class="inline-block bg-gray-200 text-gray-800 py-2 px-4 rounded-full hover:bg-gray-300 transition-colors duration-300">Apply Now</a>
                </div>
                <div class="bg-blue-100 p-6 rounded-2xl text-center shadow-custom hover:shadow-custom-hover transition-all duration-300 transform hover:-translate-y-1">
                ...
                <div class="bg-blue-100 p-6 rounded-2xl text-center shadow-custom hover:shadow-custom-hover transition-all duration-300 transform hover:-translate-y-1">
                    ...
                    <img src="https://cdn-icons-png.flaticon.com/512/4810/4810689.png" class="w-12 h-12 mx-auto mb-4" alt="Earned Leave" />
                    <a href="{{ route('teacher.notifications') }}" class="inline-block bg-gray-200 text-gray-800 py-2 px-4 rounded-full hover:bg-gray-300 transition-colors duration-300">View Now</a>
                </div>
                <div class="bg-blue-100 p-6 rounded-2xl text-center shadow-custom hover:shadow-custom-hover transition-all duration-300 transform hover:-translate-y-1">
                    <p class="text-gray-700 font-semibold text-base mb-2">Leave application Status</p>
                    <img src="https://cdn-icons-png.flaticon.com/512/1786/1786640.png" class="w-12 h-12 mx-auto mb-4" alt="Maternity/Paternity Leave" />
                    <a href="{{  route('leave.history')  }}" class="inline-block bg-gray-200 text-gray-800 py-2 px-4 rounded-full hover:bg-gray-300 transition-colors duration-300">VIew Now</a>
                </div>
                <div class="bg-blue-100 p-6 rounded-2xl text-center shadow-custom hover:shadow-custom-hover transition-all duration-300 transform hover:-translate-y-1">
                    <p class="text-gray-700 font-semibold text-base mb-2">My profile</p>
                    <img src="https://cdn-icons-png.flaticon.com/256/4466/4466498.png" class="w-12 h-12 mx-auto mb-4" alt="Maternity/Paternity Leave" />
                    <a href="{{  route('leave.history')  }}" class="inline-block bg-gray-200 text-gray-800 py-2 px-4 rounded-full hover:bg-gray-300 transition-colors duration-300">VIew Now</a>
                </div>
