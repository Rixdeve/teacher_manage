...
<body class="bg-white flex items-center justify-center min-h-screen">
    ...
    <a href="{{ route('teacher.notifications') }}" class="flex items-center w-full">
        ...
        <div class="w-full lg:w-3/4 p-4 lg:p-8 relative">
            ...
            <button onclick="history.back()" class="absolute top-14 lg:top-6 left-4 lg:left-6 bg-gray-200 hover:bg-gray-300 text-gray-800 font-semibold py-1.5 px-3 lg:py-2 lg:px-4 rounded-lg shadow-md flex items-center" aria-label="Go back">
            ...
            <div class="bg-gradient-to-b from-blue-100 to-gray-500 p-4 lg:p-6 rounded-lg mt-16 lg:mt-12 mb-6">
